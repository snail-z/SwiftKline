//
//  TQStockIndicatorSegmentedBar.h
//  TQChartKit
//
...
@protocol TQStockIndicatorSegmentedBarDelegate;

@interface TQStockIndicatorSegmentedBar : UIView

@property (nonatomic, weak) id<TQStockIndicatorSegmentedBarDelegate> delegate;
...
@protocol TQStockIndicatorSegmentedBarDelegate <NSObject>
@optional
