...
public struct PKUIEdgeInsetsExtensions {
    fileprivate static var Base: NSUIEdgeInsets.Type { NSUIEdgeInsets.self }
    fileprivate var base: NSUIEdgeInsets
    fileprivate init(_ base: NSUIEdgeInsets) { self.base = base }
}
