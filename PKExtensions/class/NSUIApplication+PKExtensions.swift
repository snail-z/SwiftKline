//
//  NSUIApplication+PKExtensions.swift
//  PKExtensions
//
...
public struct PKApplicationExtensions {
    fileprivate static var Base: NSUIApplication.Type { NSUIApplication.self }
    fileprivate var base: NSUIApplication
    fileprivate init(_ base: NSUIApplication) { self.base = base }
}
