...
public extension PKColorExtensions {
    ...
    static func random(_ scheme: ColorSchemes) -> NSUIColor {
        ...
        return NSUIColor.pk.hex(values.randomElement()!)
    }
}

public struct PKColorExtensions {
    fileprivate static var Base: NSUIColor.Type { NSUIColor.self }
    fileprivate var base: NSUIColor
    fileprivate init(_ base: NSUIColor) { self.base = base }
}
