...
public extension PKFontExtensions {
    ...
    ///   - size: 字号大小
    /// - Returns: UIFont
    static func name(_ name: FontName, style: FontStyle = .none, size: CGFloat = NSUIFont.systemFontSize) -> NSUIFont? {
    ...
    static func fontName(_ fontName: FontName, style: FontStyle = .none, size: CGFloat = NSUIFont.systemFontSize) -> NSUIFont {
...
public struct PKFontExtensions {
    fileprivate static var Base: NSUIFont.Type { NSUIFont.self }
    fileprivate var base: NSUIFont
    fileprivate init(_ base: NSUIFont) { self.base = base }
}
