...
open class UTimePreferences {
    ...
    /// 网格线颜色
    public var gridLineColor: UIColor? = .red
    ...
    /// 价格参考线宽度
    public var dashLineWidth: CGFloat = 1 / UIScreen.main.scale
    
    /// 参考线颜色
    public var dashLineColor: UIColor? = .blue
    ...
    /// 成交量柱状图颜色-涨
    public var riseColor: UIColor? = .red
    
    /// 成交量柱状图颜色-跌
    public var fallColor: UIColor? = .green
    
    /// 成交量柱状图颜色-平
    public var flatColor: UIColor? = .darkGray
    
    /// 图表部分文本颜色
    public var plainTextColor: UIColor? = .black
    
    /// 图表部分文本字体
    public var plainTextFont: UIFont? = UIFont.systemFont(ofSize: 12)
    
    /// 分时线线宽
    public var timeLineWidth: CGFloat = 1 / UIScreen.main.scale
    
    /// 分时线颜色
    public var timeLineColor: UIColor? = .purple
    
    /// 分时线填充渐变色
    public var timeLineFillGradientClolors: [UIColor?]? = [.red]
    
    /// 分时均线宽 (设置为0则隐藏)
    public var averageLineWidth: CGFloat = 1 / UIScreen.main.scale
    
    /// 分时均线颜色
    public var averageLineColor: UIColor? = .red
    
    /// 持仓线线宽 (设置为0则隐藏)
    public var positionLineWidth: CGFloat = 1 / UIScreen.main.scale
    
    /// 持仓线颜色
    public var positionLineColor: UIColor? = .brown
    ...
    /// 十字线颜色
    public var crossLineColor: UIColor? = .red
    
    /// 十字线宽度
    public var crossLineWidth: CGFloat = 1 / UIScreen.main.scale
    
    /// 十字线文本颜色
    public var crossLineTextColor: UIColor? = .red
    
    /// 十字线文本背景色
    public var crossLineBackgroundColor: UIColor? = .blue
    
    /// 十字交叉点半径 (默认为0，不显示)
    public var crossLineDotRadius: CGFloat = 0
    
    /// 十字交叉点颜色
    public var crossLineDotColor: UIColor? = .red
