...
/** 映射Y轴的文本 */
@property (nonatomic, strong) NSString *yaixsText;

/** 映射Y轴右端文本 */
@property (nonatomic, strong, nullable) NSString *yaixsSubText;

/** 映射X轴的文本 */
@property (nonatomic, strong) NSString *correspondIndexText;
